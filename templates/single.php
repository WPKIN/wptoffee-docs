...
<div class="wptoffeedocs-wrap wptoffeedocs-single-wrap">
    ...
    <div class="wptoffeedocs-content-area">
        ...
        <main id="wptoffeedocs-signle-main" <?php post_class( 'wptoffeedocs-single-main' ); ?>>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'wptoffeedocs-entry single' ); ?>>

                <header class="wptoffeedocs-entry-header">

                    <h1 class="wptoffeedocs-entry-title"><?php the_title(); ?></h1>

                </header>

                <div class="wptoffeedocs-entry-content">
            ...
            <!-- <div class="wptoffeedocs-feedback">
            ...
            <div class="wptoffeedocs-entry-footer">
